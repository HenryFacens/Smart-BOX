...
const char* mqtt_client_id = "ESP-01";
const char* mqtt_topic_photoresistor = "/smart/photoresistor/box1";  //mosquitto_sub -t "smart/controler/box1"
const char* mqtt_topic_Umidade = "/smart/Umidade/box1";
const char* mqtt_topic_Temperatura = "/smart/Temperatura/box1";
const char* mqtt_topic_noise = "/smart/noise/box1";

// public topic mosquitto_pub -m "xxxxxxxxxx" -t "smart/controler/box1"
...
//  }
  ...
  ArduinoOTA.handle();
        ...
        if(inicio == 'P')
    {
      ...
      client.publish(mqtt_topic_photoresistor, message.c_str());
    }
        if (inicio == 'U')
    {
      String message = Serial.readStringUntil('\n');
        ...
        if (inicio == 'N')
    {
      ...
      client.publish( mqtt_topic_noise, message.c_str());
    }
    }
//  if(count == 0)
//    {
//      Serial.println("controler/box1");
//    client.publish("/smart/controler/box1", message.c_str());
//    }
// count = 1;
//  if (count == 1){
//    Serial.println("photoresistor/box1");
//        client.publish("/smart/photoresistor/box1", message.c_str());
//      }
